def reward_function(params):
    ...
    def distance_from_center_reward(current_reward, track_width, distance_from_center):
        ...
        marker_11 = 0.15 * track_width
        marker_12 = 0.2 * track_width
        marker_2 = 0.25 * track_width
        marker_21 = 0.3 * track_width
        marker_22 = 0.4 * track_width
        marker_3 = 0.5 * track_width
        marker_31 = 0.7 * track_width
        marker_32 = 0.9 * track_width
